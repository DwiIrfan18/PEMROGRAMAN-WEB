                  ...
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    ...
                    <form action="modul/pemasok/proses.php?aksi=tambah" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="from-control" type="text" name="namapemasok" placeholder="Masukkan nama pemasok" required>
                        </div>
                        <div class="mb-3">
                            <label class="from-label" for="alamat">Alamat</label>
                            <input class="from-control" type="text" name="alamat" placeholder="Masukkan alamat" required>
                        </div>
                        <div class="mb-3">
                            <label class="from-label" for="telepon">Telepon</label>
                            <input class="from-control" type="text" name="telepon" placeholder="Masukkan telepon" required>
                        </div>
                        <div class="mb-3">
                            <label class="from-label" for="status">Status</label>
                            <select class="from-select" name="status">
                ...
                <div class="modal-header">
                  ...
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    ...
                    <form action="modul/pemasok/proses.php?aksi=edit&id=<?= $row_pemasok['id_pemasok'];?>"method="post">
                        ...
                        <div class="mb-3">
                            <label class="from-label" for="namapemasok">Nama Pemasok</label>
                            <input class="from-control" type="text" name="namapemasok" placeholder="Masukkan nama pemasok" value="<?= $row_pemasok['nama_pemasok'];?>" required>
                        </div>
                        <div class="mb-3">
                            <label class="from-label" for="alamat">Alamat</label>
                            <input class="from-control" type="text" name="alamat" placeholder="Masukkan alamat" value="<?= $row_pemasok['alamat'];?>" required>
                        </div>
                        <div class="mb-3">
                            <label class="from-label" for="telepon">Telepon</label>
                            <input class="from-control" type="text" name="telepon" placeholder="Masukkan telepon" value="<?= $row_pemasok['alamat'];?>" required>
                        </div>
                        <div class="mb-3">
                            <label class="from-label" for="status">Status</label>
                            <select class="from-select" name="status">
